...
<body class="d-flex">
    ...
    <nav class="flex-column p-3" id="sidebar">
        <h3 class="pt-3" style="margin-left:15px;">ALUMNI PANEL</h3>
        <a href="./index.php" class="nav-link" onclick="toggleSidebar()"><i class="bi bi-house-door"></i> Home</a>
        <a href="./jobs.php" class="nav-link" onclick="toggleSidebar()"><i class="bi bi-card-text"></i> Post Jobs</a>
        <a href="./insights.php" class="nav-link" onclick="toggleSidebar()"><i class="bi bi-megaphone-fill"></i> Discussion Forums</a>
        <a href="./add_story.php" class="nav-link" onclick="toggleSidebar()"><i class="bi bi-pencil-square"></i> Add Story</a>
        <a href="./update_profile1.php" class="nav-link" onclick="toggleSidebar()"><i class="bi bi-person"></i> Update Profile</a>
    ...
    <div class="content-container flex-grow-1" id="content">
        <h3 class="text-center">ALUMNI PANEL</h3>
